...
source: https://www.geeksforgeeks.org/check-if-a-key-is-present-in-every-segment-of-size-k-in-an-array/
...
def array_challenge_1(arr, x, k):
	for i in range(0, len(arr), k):
		if x not in arr[i:i+k]:
			return 'No'
	return 'Yes'

print(array_challenge_1([3, 5, 2, 4, 9, 3, 1, 7, 3, 11, 12, 3], 3, 3))
print(array_challenge_1([21, 23, 56, 65, 34, 54, 76, 32, 23, 45, 21, 23, 25], 23, 5))
print(array_challenge_1([5, 8, 7, 12, 14, 3, 9], 8, 2))
