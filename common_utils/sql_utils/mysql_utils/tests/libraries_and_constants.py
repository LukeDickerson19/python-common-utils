...
MYSQL_UTIL_PATH        = os.path.join(COMMON_UTILS_REPO_PATH, 'common_utils', 'sql_utils', 'mysql_utils', 'src')
...
LOG_FILEPATH = os.path.join(
	COMMON_UTILS_REPO_PATH, 'common_utils', 'sql_utils', 'mysql_utils', 'log', LOG_FILENAME)
DATA_PATH = os.path.join(
	COMMON_UTILS_REPO_PATH, 'common_utils', 'sql_utils', 'mysql_utils', 'data')
