...
OUTLOOK_UTIL_PATH      = os.path.join(COMMON_UTILS_REPO_PATH, 'common_utils', 'email_utils', 'outlook_utils', 'src')
...
LOG_FILEPATH           = os.path.join(
	COMMON_UTILS_REPO_PATH, 'common_utils', 'email_utils', 'outlook_utils', 'log', LOG_FILENAME)
